...
export default function Header() {
  return (
    <header className="flex h-[10%] items-center justify-between px-4 py-2 dark:bg-white light:bg-red-500 border-b shadow-sm">
      {/* Left Section */}
      <div className="flex items-center space-x-4">
        <Grid className="w-6 h-6 text-gray-600 cursor-pointer" />
        <span className="text-sm font-bold text-gray-800">XEOTEC CRM</span>
        <DropdownMenu>
          <DropdownMenuTrigger className="text-sm font-medium text-gray-700">
            Your work
          </DropdownMenuTrigger>
          <DropdownMenuContent>
